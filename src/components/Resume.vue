    ...
    <el-container>
        ...
        <el-container>
            <el-aside :width="collapse ?'64px':'200px'">
                ...
                <el-menu default-active="resume" background-color="#545c64" text-color="#fff" active-text-color="#409eff" 	unique-opened :collapse="isCollapse" :collapse-transition="false" :router="true">
