    ...
    <el-container>
        ...
        <el-container>
            <el-aside :width="collapse ?'64px':'200px'">
                ...
                <el-menu default-active="activityAuthority" background-color="#EBF1F6" text-color="rgb(37, 35, 35);" active-text-color="#409eff" 	unique-opened :collapse="isCollapse" :collapse-transition="false" :router="true">
                        ...
                        <el-table-column type="expand">
                            <template slot-scope="props">
                                <el-form label-position="left" inline class="demo-table-expand">
                                    ...
                                    <el-form-item label="招募日期">
                                        <span>{{props.row.recruitBeginTime}}——{{props.row.recruitEndTime}}</span>
                                    </el-form-item>
                                    
                                     <el-form-item label="活动日期">
                                        <span>{{props.row.activityBeginTime}}——{{props.row.activityEndTime}}</span>
                                    </el-form-item>
                                     <el-form-item label="招募人数">
                                        <span>{{props.row.recruitNumber}}</span>
                                    </el-form-item>
                                    <el-form-item label="工时">
                                        <span>{{ props.row.workingHours }}</span>
                                    </el-form-item>
            ...
            <el-dialog title="原因" :visible.sync="reasonVisible" width="40%" :show-close=false :close-on-click-modal='false'>
                <el-form ref="changeStatusForm" :model="changeStatusForm" :rules="changeStatusRules" label-width="110px">
                    ...
                    <el-form-item label="活动名" prop="activity.name" style="width: 60%">
                        <el-label v-model="changeStatusForm.activity.name">{{changeStatusForm.activity.name}}</el-label>
                    </el-form-item>
                    <el-form-item label="封禁原因"  prop="reason" style="width: 70%">
...
export default {
    ...
    methods:{
        ...
        async getActivity(){
            const {data:res} = await this.$http.get("administrator/activityAuthority");
        ...
        async changeToNormal(changeStatusForm){
