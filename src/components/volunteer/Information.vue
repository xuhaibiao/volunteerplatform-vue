                ...
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="密码:">
                     ...
                     <el-form-item label="性别:">
                         <el-label v-model="form.gender">{{this.options[form.gender].label}}</el-label>
                    </el-form-item>
                    ...
                    <el-form-item label="志愿分数:">
                        <el-label v-model="form.volunteerAverageScore">{{form.volunteerAverageScore}}</el-label>
                    </el-form-item>
                    <el-form-item>
...
export default {
    ...
    methods:{
        ...
        async getUserInfo(){
            ...
            this.form = res.data;
            var volunteerScore = res.data.volunteerScore;
            var num = res.data.volunteerNumber;
            if(num == 0){
                this.form.volunteerAverageScore = 0;
            }else{
                this.form.volunteerAverageScore = volunteerScore / num;
            }
        ...
        async onSubmit() {
            ...
            const {data :res} = await this.$http.post("volunteer/information/edit", this.editForm);
            if(res.code == 1){
                var user = res.data;
                this.form = user;
